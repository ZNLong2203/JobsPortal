    ...
    <footer className="bg-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/browse-jobs" className="text-gray-600 hover:text-blue-600">Browse Jobs</Link></li>
              <li><Link href="/career-advice" className="text-gray-600 hover:text-blue-600">Career Advice</Link></li>
              <li><Link href="/resume-help" className="text-gray-600 hover:text-blue-600">Resume Help</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 text-center">
          <p className="text-gray-500">&copy; 2023 FindJobs. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
